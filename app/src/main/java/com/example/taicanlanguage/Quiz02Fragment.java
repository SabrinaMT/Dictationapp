...
public class Quiz02Fragment extends AppCompatActivity {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.fragment_quiz02);
            ...
            mButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (TextUtils.isEmpty(mEditAnswer.getText().toString())){
                        Toast.makeText(com.example.taicanlanguage.Quiz02Fragment.this, "Please enter your answer", Toast.LENGTH_SHORT).show();
                    }
                        ...
                        Toast.makeText(com.example.taicanlanguage.Quiz02Fragment.this,"Correct", Toast.LENGTH_SHORT).show();
                        ...
                        mCustomAnswer.setText("Your Answer: " + CustomAnswer);
                        mCorrectAnswer.setText("Correct Answer: " + mAnswer);
                        Toast.makeText(com.example.taicanlanguage.Quiz02Fragment.this,"Wrong", Toast.LENGTH_SHORT).show();
                        mEditAnswer.getText().clear();
                    }
        ...
        private void updateQuestion(){
            if (mQuestionNumber<=24){
                mQuestionRef = new Firebase("https://quiz-139ca-default-rtdb.firebaseio.com/Sheet2/"+ mQuestionNumber +"/question");
                ...
                mAnswerRef = new Firebase("https://quiz-139ca-default-rtdb.firebaseio.com/Sheet2/"+ mQuestionNumber +"/answer");
                ...
                mButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Quiz02Fragment.this, ScoreFragment.class);
